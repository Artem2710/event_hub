                    ...
                    <div class="main-menu">
                        <div class="navbar navbar-cus">
                            <div class="navbar-header">
                                <a href="{{route('main')}}" class="navbar-brand"><span class="logo">Event_Hub</span></a>
                                <!--edit site name here-->
                            ...
                            <div class="navbar-collapse collapse">
                                <nav>
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        {{--<li><a href="" class="btn btn-primary pb-modalreglog-submit" data-toggle="modal" data-target="#myModal2">registration</a></li>--}}
                                    </ul>
                                </nav>
                            </div>
                        </div>
